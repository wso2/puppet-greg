...
1. Clone WSO2 GREG Puppet modules git repository and consider this path as `PUPPET_HOME`:

    ````
    git clone https://github.com/wso2/puppet-greg.git
    ````
...
5. Download and copy WSO2 GREG distribution to Puppet module under `files` folder:
